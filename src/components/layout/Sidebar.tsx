  ...
  if (player) return (
    <aside className="w-full max-w-[300px] h-full flex flex-col gap-4 px-2 py-4 items-center justify-between border-r bg-slate-800 border-slate-700">
      <div className=" flex flex-col gap-4 w-[90%]">
        ...
        <GameButton path="/game/character" className="flex items-center justify-between px-8 py-2">Character <Image src="/assets/sidebar/character.svg" height={40} width={40} alt="character icon" /></GameButton>
