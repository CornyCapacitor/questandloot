export const attackDescriptions: { [key: string]: string[] } = {
  ...
  dark: [
    'shrouds the target in impenetrable darkness',
    'summons shadowy tendrils that lash out at the enemy',
    'unleashes a void strike that consumes light',
    'envelops the battlefield in dark energy',
    'siphons life from the enemy through the power of shadow',
    'casts a shadow bolt that corrodes the foe’s strength',
  ],
  mystic: [
    'weaves an ethereal blast of mystical energy',
    'summons a spectral force to strike the enemy',
    'channels pure energy into a devastating strike',
    'calls upon the wisdom of ancient magic to confound the target',
    'releases a radiant burst of mystic light',
    'creates a protective aura that retaliates against attackers',
  ],
  death: [
    'summons a wave of necrotic energy that withers the target',
    'releases a deathly curse that saps the enemy’s vitality',
    'calls forth skeletal hands to drag the foe into the abyss',
    'strikes with the essence of decay, spreading blight',
    'summons a ghostly apparition to attack the target',
    'invokes the reaper’s scythe to deliver a fatal blow',
  ],
  holy: [
    'channels divine light to smite the wicked',
    'calls upon celestial power to heal allies and harm foes',
    'unleashes a blinding beam of holy energy',
    'summons angelic forces to assist in battle',
    'creates a holy shield that retaliates against enemies',
    'casts a sacred wave that purifies the battlefield',
  ],
  water: [
    'summons a wave that crashes into the target',
    'unleashes a jet of water with tremendous force',
    'creates a vortex of water that traps the enemy',
    'summons rain to hinder the enemy’s vision',
    'calls forth icicles from water to pierce the target',
    'floods the area with water to sweep enemies away',
  ],
  lightning: [
    'calls down a bolt of lightning from the heavens',
    'strikes the target with a shocking burst of energy',
    'sends a chain of lightning to arc between foes',
    'unleashes a thunderclap that stuns all nearby',
    'summons a storm to rain down electric fury',
    'delivers a shocking grasp that leaves the target paralyzed',
  ],
  bow: [
